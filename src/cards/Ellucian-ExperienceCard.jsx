...
const Ellucian-ExperienceCard = (props) => {
    const { classes } = props;

    return (
        <div className={classes.card}>
            <Typography variant="h2">
                Hello Ellucian-Experience World
            </Typography>
            <Typography>
                <span>
...
Ellucian-ExperienceCard.propTypes = {
    classes: PropTypes.object.isRequired
};

export default withStyles(styles)(Ellucian-ExperienceCard);